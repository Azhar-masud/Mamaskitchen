                  ...
                  <div class="table-responsive">
                    <table id="table" class="table" style="width:100%">
                      ...
                      <tbody>
                          ...
                          <button type="button" onclick="deleteads({{ $reserve->id }})" class="btn btn-danger btn-sm ml-2" data-toggle="modal" data-target=".bd-example-modal-lg" title="Delete"><i class="material-icons">delete</i></button>
